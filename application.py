...
def bookspage(ISBN):
    if session.get('user') is None:
        ...
        return render_template("bookspage.html", Search="T", Bookspage="T", Login="F", NewUser="F", Logout="T" , book=book, ratings_count=ratings_count,average_rating=average_rating, username=session['user'])
